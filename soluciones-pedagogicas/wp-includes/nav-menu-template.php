...
function wp_nav_menu( $args = array() ) {
	...
	$nav_menu = str_replace('class="menu-menu-1-container"', 'class="collapse navbar-collapse navbar-ex1-collapse"', $nav_menu);
	
	$nav_menu = str_replace('class="nav-menu"', 'class="nav navbar-nav nav-menu"', $nav_menu);
		
	
	$nav_menu = str_replace('menu-item-has-children menu-item-219"><a','menu-item-has-children dropdown  menu-item-219"><a class="dropdown-toggle" data-toggle="dropdown"', $nav_menu);
	
	$nav_menu = str_replace('menu-item-has-children menu-item-248"><a','menu-item-has-children dropdown  menu-item-248"><a class="dropdown-toggle" data-toggle="dropdown"', $nav_menu);
	
	$nav_menu = str_replace('planificacion</a','planificacion<b class="caret"></b></a', $nav_menu);
	
	$nav_menu = str_replace('class="sub-menu"', 'class="sub-menu dropdown-menu"', $nav_menu);

<?php
/*
Template Name: consulta_planificacion_unidad
*/
        ...
        <div class="row">
        	<div class="span12">
            	<div class="row">
					...
					?>
                    	<div class="span2">
                        	<button class="boton_agregar" onClick="agregar_conceptos(); return false;"></button>
                        </div>	
                    </div>                 
                </div>                            	
            </div>
            	...
            	<div class="row">
                    ...
                    <?
							...
							$cantidad_indicadores=count($objetivos['objetivo'.$i]);				 
								...
								?>
				            		<textarea class="form-control input_con_sombra" rows="3" type="text" name="Indicadores_<? echo $i; ?>[]" id="indicador_<? echo $i.'_'.$x; ?>"> <? echo $objetivos['objetivo'.$i]['indicador'.$x]; ?></textarea>
        ...
        <div class="row">
        	<div class="span12">
            	<div class="row">
                    ...
                    <div class="span7">
    	              	<textarea class="form-control input_con_sombra" rows="3" type="text" name="EstrategiaAprendizaje[]"> <? echo $objetivos['objetivo'.$i]['estrategia_aprendizaje']; ?></textarea>	
                    </div>
                </div>
            </div>
		</div>  
        ...
        <div class="row">
        	<div class="span12">
            	<div class="row">
                    ...
                    <div class="span7">
    	              	 <textarea class="form-control input_con_sombra" rows="3" type="text" name="FormasEvaluacion[]"> <? echo $objetivos['objetivo'.$i]['formas_evaluacion']; ?></textarea>	
                    </div>
                </div>
            </div>
		</div>
